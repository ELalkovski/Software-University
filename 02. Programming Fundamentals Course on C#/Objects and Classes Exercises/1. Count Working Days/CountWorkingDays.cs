namespace _1.Count_Working_Days
{
    ...
    public class CountWorkingDays
    {
        public static void Main()
        {
            ...
            DateTime start = DateTime.ParseExact(firstInput, "dd-MM-yyyy", CultureInfo.InvariantCulture);
            DateTime end = DateTime.ParseExact(secondInput, "dd-MM-yyyy", CultureInfo.InvariantCulture);
